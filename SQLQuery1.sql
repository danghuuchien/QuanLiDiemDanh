...
select HoTenGV
from GIANGVIEN, LOPMONHOC
WHERE LOPMONHOC.MaGV=GIANGVIEN.MaGV AND MaLopMH='LMH101'
use DIEMDANH
select * from account
...
select count(*) from DIEMDANH where( VangCoPhep= 0 and VangKhongPhep= 0) and Ngay= '2023-04-01' and MaLopMH= 'LMH101';
SELECT * FROM LOPMONHOC
select TenLopMH from Lopmonhoc where MaLopMH='LMH101'